    ...
    play(){
        ...
        if(player.index===1){
          ...
          form.button2.mousePressed(()=>{
            text(hint2[ord1[player.level]],400,500)
          })

          form.submit.mousePressed(()=>{
            console.log("hii")
            var ans=form.textBox.value()
            ans=ans.trim()
            ans=ans.toLowerCase()
            console.log(ans)
            ...
            if(ans===answers[ord1[player.level]]){
              ...
              player.update()
              console(player.level)
            }
          })

          textAlign(LEFT)
          textSize(20)
          text(questions[ord1[player.level]],0,100)
          ...
          textAlign(RIGHT)
          textSize(20)
          text(questions[ord1[player.level]],1350,100)
        }
